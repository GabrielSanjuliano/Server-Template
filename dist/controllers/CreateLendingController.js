...
var CreateLendingController = /** @class */ (function () {
    ...
    CreateLendingController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, client_id, lending_value, received_value, lending;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, client_id = _a.client_id, lending_value = _a.lending_value, received_value = _a.received_value;
